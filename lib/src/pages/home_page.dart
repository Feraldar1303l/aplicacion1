import 'package:aplicacion1/src/providers/menu_providers.dart';
import 'package:aplicacion1/src/utils/icono_string_util.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0x1F),
        title: Text('Prueba de ListView'),
      ),
      body: _lista(), //llama al widget creado
    );
  }

  Widget _lista() {
    //Crea el widget lista
  ...
  List<Widget> _listaItems(BuildContext context, List<dynamic> data) {
    ...
    data.forEach((opt) {
      //Jala los datos del archivo Json a una lista con un metodo forEachs
